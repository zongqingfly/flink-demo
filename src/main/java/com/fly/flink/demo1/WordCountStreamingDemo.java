...
public class WordCountStreamingDemo {
    public static void main(String[] args) throws Exception {
        ...
        // RuntimeExecutionMode.AUTOMATI: Flink will set the execution mode to BATCH if all sources are bounded,
        // or STREAMING if there is at least one source which is unbounded.
        // env.setRuntimeMode(RuntimeExecutionMode.AUTOMATIC);
        env.setRuntimeMode(RuntimeExecutionMode.STREAMING); // 默认模式，不写也可以
